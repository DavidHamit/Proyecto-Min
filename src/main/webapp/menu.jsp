...
<li class="li"><a href="index.jsp">Salir</a></li>
    ...
    <main>
        <section class="section" id="section1">
            <p class="p1">Bienvenido a nuestra Tienda Genérica, esperamos lograr sus expectativas como cliente.</p>
            <p class="p2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero velit maiores eligendi sunt consequuntur expedita, corporis cum</p> 
        </section>
    </main>
</body>
</html>